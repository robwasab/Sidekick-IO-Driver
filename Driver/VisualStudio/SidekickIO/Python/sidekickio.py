...
class SidekickIO(object):
    ...
    CMD_GPIO_SET_LED = _sidekickio.SidekickIO_CMD_GPIO_SET_LED
    ...
    def get_status(self):
        return _sidekickio.SidekickIO_get_status(self)
    ...
    def i2cm_write_data(self, slave_addr, data):
        return _sidekickio.SidekickIO_i2cm_write_data(self, slave_addr, data)

    def i2cm_read_data(self, slave_addr, data, len):
        return _sidekickio.SidekickIO_i2cm_read_data(self, slave_addr, data, len)

    def i2cm_write_register(self, slave_addr, reg, data):
        return _sidekickio.SidekickIO_i2cm_write_register(self, slave_addr, reg, data)
    ...
    def spim_transfer_packet(self, cs_index, data):
        return _sidekickio.SidekickIO_spim_transfer_packet(self, cs_index, data)

    def spim_transfer(self, cs_index, data):
        return _sidekickio.SidekickIO_spim_transfer(self, cs_index, data)

    def spim_write(self, cs_index, data):
        return _sidekickio.SidekickIO_spim_write(self, cs_index, data)

    def spim_write_byte(self, cs_index, val):
        return _sidekickio.SidekickIO_spim_write_byte(self, cs_index, val)

    def gpio_set_led(self, on):
        return _sidekickio.SidekickIO_gpio_set_led(self, on)
    ...
    def send_echo(self, data, match):
        return _sidekickio.SidekickIO_send_echo(self, data, match)
    ...
    def firmware_update(self, data, reset_mode):
        return _sidekickio.SidekickIO_firmware_update(self, data, reset_mode)
